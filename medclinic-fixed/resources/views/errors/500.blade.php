...
<head>
    ...
    <title>Erreur Serveur — MedClinic</title>
...
<div class="container">
    <div class="error-card">
        ...
        <h3 class="fw-bold mt-2">Erreur serveur</h3>
        <p class="text-muted">Une erreur interne s'est produite. Notre équipe a été notifiée.</p>
