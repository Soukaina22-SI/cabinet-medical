...
<form method="POST"
      action="{{ isset($patient) ? route('patients.update', $patient) : route('admin.patients.store') }}">
    @csrf
    ...
    <div class="d-flex gap-2 justify-content-end">
        <a href="{{ route('patients.index') }}" class="btn btn-outline-secondary px-4">Annuler</a>
